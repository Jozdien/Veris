    ...
    return(
      <View style={styles.parent}>
        ...
        <ActionButton buttonColor="rgba(229, 105, 103, 1)" btnOutRange="rgba(229, 105, 103, 1)" degrees={45}>
          <ActionButton.Item buttonColor='#E56967' title="Blogs" onPress={() => {this.props.navigation.navigate("Blogs")}}>
            <Icon3 name="blog" size={14}/>
          </ActionButton.Item>
          ...
          <ActionButton.Item buttonColor='#E569E5' title="Fees" onPress={() => {this.props.navigation.navigate("Fees")}}>
